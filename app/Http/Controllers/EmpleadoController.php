...
class EmpleadoController extends Controller
{
    public function index(Request $request)
    {
        ...
        $response = Http::get('https://rrhh-didadpol-1.onrender.com/api/empleados');
    ...
    public function store(Request $request)
    {
        ...
        $respuesta = Http::asMultipart()->post('https://rrhh-didadpol-1.onrender.com/api/empleados', $multipart);
    ...
    public function update(Request $request, $id)
    {
        ...
        $respuesta = Http::asMultipart()->put("https://rrhh-didadpol-1.onrender.com/api/empleados/{$id}", $multipart);

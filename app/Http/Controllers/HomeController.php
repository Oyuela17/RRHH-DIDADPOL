...
class HomeController extends Controller
{
    ...
    private string $apiAsistenciaBase = 'https://rrhh-didadpol-1.onrender.com/api/asistencia';

    // Siguen vivas tus rutas de métricas existentes
    private string $apiUrlEmpleados = 'https://rrhh-didadpol-1.onrender.com/api/empleados/total';
    private string $apiUrlUsuarios  = 'https://rrhh-didadpol-1.onrender.com/api/usuarios/total';
